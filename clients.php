...
?>
        ...
        <!-- subheader begin -->
        <section id="subheader" class="page-client no-bottom" data-stellar-background-ratio="0.5">
            <div class="inner">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
...
distribution.
							...
							<p>BGT was established in 2005 and provides integrated supply chain solutions across UAE. With our extensive local footprint and strong expertise in supply chain logistics, we offer unparalleled levels
